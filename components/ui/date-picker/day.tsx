import { CALENDAR_HEIGHT } from "@/lib/constants/date-picker";
import { CalendarThemeProps, IDayObject } from "@/lib/types/date";
import { addColorAlpha } from "@/lib/utils/date-picker";
...
function Day({
  ...
  const style = styles(CALENDAR_HEIGHT);
